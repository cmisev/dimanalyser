...
public class Globals {
	...
	public static final PhysicalUnit UNIT_UNITLESS = new PhysicalUnit(1.0, new double[]{0.0,0.0,0.0});
	...
	public static void initUnits() {
		...
		units.put("m", new PhysicalUnit(1.0, new double[]{1.0,0.0,0.0}));
		units.put("kg",new PhysicalUnit(1.0, new double[]{0.0,1.0,0.0}));
		units.put("s", new PhysicalUnit(1.0, new double[]{0.0,0.0,1.0}));
		units.put("N", new PhysicalUnit(1.0, new double[]{1.0,1.0,-2.0}));
		units.put("J", new PhysicalUnit(1.0, new double[]{2.0,1.0,-2.0}));
	}
}
